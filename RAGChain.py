    ...
    def __init__(self, llm, retriever, session_ids, store):
        ...
        self.prompt = PromptTemplate.from_template(
                                                    """
                                                        ...
                                                        - 카드 추천은 어떤 카드가 좋은지 물어봤을 때만 하셔야 합니다. 단순 비교나 계산 질문일 경우 계산 결과만 답하고 카드추천을 하면 안됩니다.
                                                            - 예 : 질문 : "내가 카페에서 얼마 썼어", 대답 : "고객님은 카페에 24600원 썼습니다."
                                                            - 예 : 질문 : "나에게 맞는 카드가 뭐야?", 대답 : "고객님께 맞는 카드는 첵첵, 청춘대로, BeVV 입니다."
                                                            - 예 : 질문 : "나에게 혜택이 좋은 카드가 뭐야?", 대답 : "고객님께 맞는 카드는 우리동네, BeVV, 트래블러스 입니다."
